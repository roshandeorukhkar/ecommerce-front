                           ...
                           <div className="bz_pos_list_wrapper float_left">
                              <ul>
                                 ...
                                 <li>
                                    ...
                                    <div className="icon_list">
                                       <a href="#">Free Shipping <span>on order over <i class="fas fa-rupee-sign fa-sm"></i>99</span> </a>
                                    </div>
                                 </li>
                              </ul>
                           </div>
                                       ...
                                       <div className="item" style={{width:'99%'}}>
                                          <div className="product_box">
                                             ...
                                             <div className="product_content">
                                                ...
                                                <h4><i class="fas fa-rupee-sign fa-sm"></i>500.00 <span> <del><i class="fas fa-rupee-sign fa-sm"></i>679.00</del> </span> </h4>
                                                <a className="add_btn custom_btn" href="#">Add to Cart</a>
                                             </div>
                                          </div>
                                       </div>
                                       <div className="item" style={{width:'99%'}}>
                                          <div className="product_box">
                                             ...
                                             <div className="product_content">
                                                ...
                                                <h4><i class="fas fa-rupee-sign fa-sm"></i>800.00 <span> <del><i class="fas fa-rupee-sign fa-sm"></i>900.00</del> </span> </h4>
                                                <a className="add_btn custom_btn" href="#">Add to Cart</a>
                                             </div>
                                          </div>
                                       </div>
